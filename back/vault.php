                    ...
                    <div class="col-12">
                        <div class="QA_section">
                            <div class="white_box_tittle list_header">
                                <h4 style="text-align:center; margin-top:10px !important; ">VAULT NUMBER : <span style="color:#FFB400;"><?php gdetail($_SESSION['vaultuser']['gold_id'], 'vaultnumber'); ?> </span> <a href="" class="btn btn-danger">Logout</a></h4>
